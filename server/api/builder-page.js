...
function renderBuilderHtml({ slip, token, liveDataAvailable }) {
  ...
  html = html
    ...
    .replace(/<script src="\.\/app\.js"><\/script>/, `<script>window.__PARLAYPING_BUILDER__=${payload};</script><script src="/builder-precision-runtime.js"></script><script src="/builder-concept-finish.js"></script><script src="/builder-mobile-fix.js"></script>`)
  ...
  html = html.replace('</head>', `<link rel="stylesheet" href="/builder-precision.css" /><link rel="stylesheet" href="/builder-mobile-fix.css" />${social}</head>`);
  return html;
}
