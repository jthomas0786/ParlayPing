...
function normBook(value){
  ...
  const map={draftkings:'DraftKings',dk:'DraftKings',fanduel:'FanDuel',fd:'FanDuel',bet365:'bet365',caesars:'Caesars',caesarssportsbook:'Caesars',williamhill:'Caesars',betmgm:'BetMGM',mgm:'BetMGM',fanatics:'Fanatics',fanaticssportsbook:'Fanatics',hardrock:'Hard Rock',hardrockbet:'Hard Rock',betrivers:'BetRivers',pinnacle:'Pinnacle',bovada:'Bovada',parx:'Parx',parxcasino:'Parx'};
...
module.exports={analyzeBasketballSlip,closestEventRow,pregameResult,quoteProbabilitySafe,sportsbookQuotesSafe,marketOptionsSafe,withEspnServerFetch,normPlayerName,normBook,sideSelectionLink,repairVisionMarket};